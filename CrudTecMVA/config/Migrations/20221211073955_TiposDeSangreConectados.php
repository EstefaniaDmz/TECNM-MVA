...
class TiposDeSangreConectados extends AbstractMigration
{
    /**
     * Up Method.
     *
    ...
    public function up(): void
    {
        ...
        $this->table('TiposDeSangreConectados', ['id' => false])
            ->addColumn('idTipoSangre', 'integer', [
                'default' => null,
                'limit' => 10,
                'null' => true,
    ...
    public function down(): void
    {
        ...
        $this->table('TiposDeSangreConectados')->drop()->save();
