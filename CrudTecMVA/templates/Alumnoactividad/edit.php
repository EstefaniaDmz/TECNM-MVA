...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $alumnoactividad->idAlumnoActividad],
                ['confirm' => __('Are you sure you want to delete # {0}?', $alumnoactividad->idAlumnoActividad), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="alumnoactividad form content">
            ...
            <fieldset>
                <legend><?= __('Edit Alumnoactividad') ?></legend>
                <?php
