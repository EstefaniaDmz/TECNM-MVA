...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $organizacion->idOrganizacion],
                ['confirm' => __('Are you sure you want to delete # {0}?', $organizacion->idOrganizacion), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="organizacion form content">
            ...
            <fieldset>
                <legend><?= __('Edit Organizacion') ?></legend>
                <?php
