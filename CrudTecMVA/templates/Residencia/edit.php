...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $residencium->idResidencia],
                ['confirm' => __('Are you sure you want to delete # {0}?', $residencium->idResidencia), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="residencia form content">
            ...
            <fieldset>
                <legend><?= __('Edit Residencium') ?></legend>
                <?php
