...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $alumnotutor->idAlumnoTutor],
                ['confirm' => __('Are you sure you want to delete # {0}?', $alumnotutor->idAlumnoTutor), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="alumnotutor form content">
            ...
            <fieldset>
                <legend><?= __('Edit Alumnotutor') ?></legend>
                <?php
