...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $solicitudconsumible->idSolicitudConsumible],
                ['confirm' => __('Are you sure you want to delete # {0}?', $solicitudconsumible->idSolicitudConsumible), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="solicitudconsumible form content">
            ...
            <fieldset>
                <legend><?= __('Edit Solicitudconsumible') ?></legend>
                <?php
