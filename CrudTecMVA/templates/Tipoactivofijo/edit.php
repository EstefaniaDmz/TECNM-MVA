...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $tipoactivofijo->idTipoActivoFijo],
                ['confirm' => __('Are you sure you want to delete # {0}?', $tipoactivofijo->idTipoActivoFijo), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="tipoactivofijo form content">
            ...
            <fieldset>
                <legend><?= __('Edit Tipoactivofijo') ?></legend>
                <?php
