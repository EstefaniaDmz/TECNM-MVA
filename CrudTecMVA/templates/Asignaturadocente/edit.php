...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $asignaturadocente->idAsignaturaDocente],
                ['confirm' => __('Are you sure you want to delete # {0}?', $asignaturadocente->idAsignaturaDocente), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="asignaturadocente form content">
            ...
            <fieldset>
                <legend><?= __('Edit Asignaturadocente') ?></legend>
                <?php
