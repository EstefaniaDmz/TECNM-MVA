...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $enfermeriaservicio->idEnfermeriaServicio],
                ['confirm' => __('Are you sure you want to delete # {0}?', $enfermeriaservicio->idEnfermeriaServicio), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="enfermeriaservicio form content">
            ...
            <fieldset>
                <legend><?= __('Edit Enfermeriaservicio') ?></legend>
                <?php
